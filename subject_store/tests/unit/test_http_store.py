...
from subject_store._drivers import http
...
from subject_store.tests import utils
...
class TestHttpStore(base.StoreBaseTest,
    ...
    def setUp(self):
        ...
        self.config(default_store='http', group='subject_store')
