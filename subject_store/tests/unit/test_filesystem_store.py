...
from subject_store._drivers.filesystem import ChunkedFile
from subject_store._drivers.filesystem import Store
...
class TestStore(base.StoreBaseTest,
    ...
    def setUp(self):
        ...
        self.config(filesystem_store_datadir=self.test_dir,
                    stores=['subject.store.filesystem.Store'],
                    group="subject_store")
    ...
    def test_delete_non_existing(self):
        ...
        """
        loc = location.get_location_from_uri(
            "file:///tmp/subject-tests/non-existing", conf=self.conf)
        self.assertRaises(exceptions.NotFound,
                          self.store.delete,
                          loc)
