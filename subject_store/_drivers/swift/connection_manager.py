...
class SwiftConnectionManager(object):
    ...
    def __init__(self, store, store_location, context=None,
        ...
        :param store_location: subject location in store
    ...
    def get_connection(self):
        ...
        if self.allow_reauth:
            ...
            if auth_ref.will_expire_soon(
                self.store.conf.subject_store.swift_store_expire_soon_interval
            ):
    ...
    def client(self):
        ...
        Initialize a client lazily from the method provided by subject_store.
...
class SingleTenantConnectionManager(SwiftConnectionManager):
    ...
    def _init_connection(self):
        if self.store.auth_version == '3':
            ...
            # no re-authentication for v1 and v1
