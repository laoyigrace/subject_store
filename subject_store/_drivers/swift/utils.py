...
subject storage. The default reference value for this configuration
option is 'ref1'. This configuration option dereferences the
parameters and facilitates subject storage in Swift storage backend
every time a new subject is added.
...
subject storage as it avoids storage of credentials in the database.

Possible values:
    * String value representing an absolute path on the subject-api
      node
